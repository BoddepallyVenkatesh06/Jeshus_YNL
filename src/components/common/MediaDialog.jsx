...
export function MediaDialog({ mediaDialogOpen, handleMediaDialogOpen }) {
...
MediaDialog.propTypes = {
  mediaDialogOpen: PropTypes.bool,
  handleMediaDialogOpen: PropTypes.func,
};
